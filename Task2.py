...
class BOESidewalkAI():
    ...
    def edgeDection(self,filename):
        img = cv2.imread(self.directory + filename,1)
...
if __name__ == "__main__":
    ...
    boesidewalkAI = BOESidewalkAI(directory='/Edit') #C:/Users/name/Desktop/SCHOOL/Fall2020/SD/Edit where walk.jpg is saved
    boesidewalkAI.edgeDection('walk.jpg')
    boesidewalkAI.segBinary('walk.jpg')
    # boesidewalkAI.segGrabCut('images.jfif', 'images2.jpg')